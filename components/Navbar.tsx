...
const links = [{href:"/catalogo",label:"Catálogo"},{href:"/agent-chat",label:"Agent Chat"},{href:"/webmcp-playground",label:"WebMCP"},{href:"/buyer-execution",label:"Workspace"},{href:"/publish",label:"Publicar"},{href:"/history",label:"Historial"},{href:"/docs",label:"Docs"}];
