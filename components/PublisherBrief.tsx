...
Pregunta solo por los datos pendientes y determina si ya tengo una API o solo una idea. Reutiliza la implementación existente cuando corresponda. Define las entradas, el formato de entrega y los límites; comprueba que el servicio produce lo declarado y señala cualquier muestra simulada.

Prepara o adapta la integración y valida la ficha. Confirma disponibilidad, condiciones, precio y destino público de cobro conmigo antes de preparar la prueba de control y solicitar revisión manual. Si falla una validación, explica qué corregir y no avances como si estuviera aprobada.

Resume lo listo y lo pendiente. No inventes información ni solicites claves privadas. Validar la ficha no implica aprobación ni publicación. No ejecutes pagos ni publiques automáticamente.
