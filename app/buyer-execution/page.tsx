...
export default function BuyerExecutionPage() {
  return <main>
    ...
    <nav className="nav shell">
      ...
      <div className="nav-links"><Link href="/#catalogo">Catálogo</Link><Link href="/payment-flow">Modelo x402</Link><Link href="/#proveedores-verificados">Website Intelligence</Link><Link href="/docs">Docs</Link></div>
