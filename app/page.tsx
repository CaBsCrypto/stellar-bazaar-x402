...
export default function Home(){return <main>
  ...
  <nav className="nav shell"><Link href="/" className="brand"><span>✦</span> Stellar Bazaar <sup>x402</sup></Link><div className="nav-links"><a href="#producto">Qué es</a><a href="#catalogo">Catálogo</a><a href="#proveedores-verificados">Pilotos HTTPS</a><Link href="/payment-flow">Flujo buyer↔provider</Link><a href="#workflows">Workflows</a><Link href="/onboarding">Onboarding</Link><Link href="/publish">Publica tu servicio</Link><Link href="/docs">Docs</Link><a href="https://github.com/CaBsCrypto/stellar-bazaar-x402">GitHub ↗</a></div><span className="network-pill"><i/> Testnet en vivo</span></nav>
